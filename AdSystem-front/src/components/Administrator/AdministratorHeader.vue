...
<template>
  <div style="height: 50px; border-bottom: 1px solid #ccc; display: flex; align-items: center;">
    <div style="width: 150px; text-align: center; font-weight: bold; color: dodgerblue;">管理员后台管理</div>
    ...
    <div style="width: 100px;">
      <el-dropdown>
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item @click="goToPage('/admin/admin-user-info')">个人信息</el-dropdown-item>
